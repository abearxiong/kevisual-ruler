...
/* harmony export */ });
/* unused harmony exports Form, HashRouter, Link, NavLink, ScrollRestoration, createBrowserRouter, createHashRouter, createSearchParams, unstable_HistoryRouter, useFetcher, useFetchers, useFormAction, useLinkClickHandler, useSearchParams, useSubmit */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(363);
...
const useSyncExternalStore = "useSyncExternalStore" in react__WEBPACK_IMPORTED_MODULE_0__ ? (module => module.useSyncExternalStore)(react__WEBPACK_IMPORTED_MODULE_0__) : shim;
...
function createRoutesFromChildren(children, parentPath) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0__.Children.forEach(children, (element, index) => {
    ...
    !(!element.props.index || !element.props.children) ?  false ? 0 : (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .invariant */ .kG)(false) : void 0;
    let treePath = [...parentPath, index];
    let route = {
